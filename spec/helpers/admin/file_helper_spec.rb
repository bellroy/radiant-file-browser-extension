...
describe Admin::FileHelper do
  ...
  it "should display a directory" do
    ...
    str += '<span class="title"><a href=\'/admin/files/edit\?id='+@test_dir_id+'\'>Test1</a></span>(\s)*'
  ...
  it "should display a file" do
    ...
    str += '<img alt="" class="icon" src="/images/admin/page.png\?(\d)*" />(\s)*'
    str += '<span class="title"><a href=\'/admin/files/edit\?id='+@test_file_id+'\'>testfile.jpg</a></span>(\s)*'
    str += '</td>(\s)*'
    str += '(\s)*'
